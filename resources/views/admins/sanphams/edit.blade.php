                            ...
                            <form action="{{ route('admins.sanphams.update',$sanPham->id) }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            <label for="gia_khuyen_mai" class="form-label">Giá khuyễn mãi</label>
                                            <input type="number" id="gia_khuyen_mai" name="gia_khuyen_mai"
                                                class="form-control @error('gia_khuyen_mai') is-invalid @enderror"
                                                value="{{  $sanPham->gia_khuyen_mai }}" placeholder="Giá khuyễn mãi">
                                        ...
                                        <div class="mb-3">
                                            <label for="mo_ta_ngan" class="form-label">Mô tả ngắn</label>
                                                <textarea name="mo_ta_ngan" id="mo_ta_ngan"  class="form-control @error('mo_ta_ngan') is-invalid @enderror"  rows="3" placeholder="Mô tả ngắn">{{  $sanPham->mo_ta_ngan }}</textarea>
                                            @error('mo_ta_ngan')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <img id="img_danh_muc" src="{{ Storage::url($sanPham->hinh_anh) }}" alt="Hình Ảnh Sản Phẩm"
                                                ...
                                                <tbody id="image-table-body">
                                                 ...
                                                 <tr>
                                                    <td class="d-flex align-item-center">
                                                        <img id="preview_{{$index}}" src="{{ Storage::url($hinhAnh->hinh_anh) }}" alt="Hình Ảnh SẢn Phẩm"
                                                        style="width: 50px" class="me-3">
                                                        <input type="file" id="hinh_anh" name="list_hinh_anh[{{$hinhAnh->id}}]" class="form-control"
