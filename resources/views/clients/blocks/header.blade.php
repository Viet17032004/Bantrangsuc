                      ...
                      <div class="main-menu-area">
                          <div class="main-menu">
                              ...
                              <nav class="desktop-menu">
                                  <ul>
                                      <li class="active"><a href="{{route('home')}}">Danh mục sản phẩm <i class="fa fa-angle-down"></i></a>
                                          <ul class="dropdown">
                                             
                                              @if(isset($categories) && count($categories) > 0)
                                              @foreach($categories as $category)
                                              <li><a href="{{ route('categories.show', $category->id) }}">{{ $category->ten_danh_muc }}</a></li>
