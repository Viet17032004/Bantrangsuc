                ...
                <div class="col-lg-12">
                  <div class="myaccount-content">
                    ...
                    <div class="welcome">
                        ...
                        <p>Emial người nhận<strong>{{$donHang->email_nguoi_nhan}}</strong></p>
                        ...
                        <p>Tiền hàng<strong> {{ number_format($donHang->tien_hang, 0, '', '.') }} VNĐ</strong></p>
                        <p>Tiền ship<strong> {{ number_format($donHang->tien_ship, 0, '', '.') }} VNĐ</strong></p>
                        <p>Tổng tiền<strong> {{ number_format($donHang->tong_tien, 0, '', '.') }} VNĐ</strong></p>
                    </div>
