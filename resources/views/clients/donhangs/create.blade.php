...
@section('css')
<!-- Include any specific CSS for this page here -->
@endsection
                   ...
                   <div class="checkout-billing-details-wrap">
                       ...
                       <div class="billing-form-wrap">
                               ...
                               <div class="single-input-item">
                                   ...
                                   <input type="text" id="so_dien_thoai_nguoi_nhan" name="so_dien_thoai_nguoi_nhan" placeholder="Nhập Số điện thoại người nhận"  value="{{Auth::user()->so_dien_thoai}}" />
                               ...
                               <div class="single-input-item">
                                   ...
                                   <input type="text" id="dia_chi_nguoi_nhan" name="dia_chi_nguoi_nhan" placeholder="Nhập địa chỉ người nhận"  value="{{Auth::user()->dia_chi}}" />
                           ...
                           <div class="order-summary-table table-responsive text-center">
                               <table class="table table-bordered">
                                   ...
                                   <tbody>
                                       ...
                                       <tr>
                                           <td><a href="{{ route('products.detail', $key) }}">{{$item['ten_san_pham']}} <strong> × {{$item['so_luong']}}</strong></a></td>
                                   ...
                                   <tfoot>
                                       <tr>
                                           <td>Sub Total</td>
                                           <td><strong>{{ number_format($subtotal, 0, '', '.') }} VNĐ</strong>
                                            <input type="hidden" name="tien_hang" value="{{ $subtotal }}"></td>
                                           
                                       </tr>
                                       <tr>
                                           <td>Shipping</td>
                                           <td><strong>{{ number_format($shipping, 0, '', '.') }} VNĐ</strong>
                                            <input type="hidden" name="tien_ship" value="{{ $shipping }}"></td>
                                          
                                       </tr>
                                       <tr>
                                           <td>Total Amount</td>
                                           <td><b>{{ number_format($total, 0, '', '.') }} VNĐ</b>
                                            <input type="hidden" name="tong_tien" value="{{ $total  }}"></td>
...
@section('js')
<!-- Include any specific JS for this page here -->
@endsection
