                            ...
                            <div class="cart-calculate-items">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        <tr>
                                            <td>Sub Total</td>
                                            <td class="sub-total">{{ number_format($subTotal, 0, '', '.') }} VNĐ</td>
                                        </tr>
                                        <tr>
                                            <td>Shipping</td>
                                            <td class="shipping">{{ number_format($shipping, 0, '', '.') }} VNĐ</td>
                                        </tr>
                                        <tr class="total">
                                            <td>Total</td>
...
@section('js')
    <script>
        ...
        function updatetotal() {
            ...
            var shipping = parseFloat($('.shipping').text().replace(/\./g, '').replace(/\./g, ''))
        ...
        $('.qtybtn').on('click', function() {
            ...
            //Cập  nhật lại giá trị của subtottal
            var price = parseFloat($input.data('price'));
            var subtotalElement = $input.closest('tr').find('.subtotal');
            var newSubtotal = newVal * price;
            subtotalElement.text(newSubtotal.toLocaleString('vi-VN') + 'VNĐ')
            updatetotal();
